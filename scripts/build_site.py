...
<head>
  ...
  <style>
    ...
    * {{ box-sizing: border-box; }}
    ...
    .price-panel, .technical-panel, .driver-panel, .recent-panel, .evidence-unit {{
      border: 1px solid var(--line);
      border-radius: 14px;
      background: var(--panel);
    }}
    ...
    .driver-head, .driver-row {{
      display: grid;
      grid-template-columns: 62px minmax(110px, 1fr) 100px 110px minmax(150px, 1.2fr) 112px 72px;
      gap: 10px;
      align-items: center;
    }}
    .driver-head {{
